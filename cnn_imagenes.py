...
info_directorio = Path('./imagenes_entrenamiento/')
...
imagenes_prueba = [
    './imagenes_pruebas/granadilla.jpg',
    './imagenes_pruebas/granola.jpg',
    './imagenes_pruebas/hojuelas-azucaradas.jpg',
    './imagenes_pruebas/leche.jpg',
    './imagenes_pruebas/lenteja.jpg',
    './imagenes_pruebas/limon.jpg',
    './imagenes_pruebas/manazana.jpg',
    './imagenes_pruebas/queso.jpg',
    './imagenes_pruebas/yogurt.jpg',
...
modelo.save("export/modelo_Dectector_Alimentos.h5")
with open("export/labels.txt", "w", encoding="utf-8") as f:
    for name in LISTA_NOMBRE_CLASES:
        f.write(name + "\n")

print("\nModelo guardado como 'export/modelo_Dectector_Alimentos.h5' y labels en export/labels.txt")
